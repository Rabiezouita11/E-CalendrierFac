...
<body>
    ...
    <?php
        ...
        $emplois = \App\Emploi::orderBy('date', 'asc')->orderBy('hd', 'asc')->get();
    ?>
...
<?php $i=0;$heur=array( );?>
       ...
       $d2 = \App\Emploi::where('hd', $h)->where('date', $d->date)->get();
             ?>
             <td> 
                @foreach ($d2 as $d)
                    
                
                <?php $gps = explode (" ", substr($d->Groupe, 1));  ?>
